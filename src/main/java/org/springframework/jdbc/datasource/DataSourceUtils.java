...
public abstract class DataSourceUtils {
	...
	public static Connection doGetConnection(DataSource dataSource) throws SQLException {
		...
		ConnectionHolder conHolder = (ConnectionHolder) MybatisTransactionScope.getTransactionSynchronizationManagerResource(dataSource);
		...
		if (transactionSynchronizationManager!=null && transactionSynchronizationManager.isSynchronizationActive()) {
			try {
				...
				transactionSynchronizationManager.registerSynchronization(
						new ConnectionSynchronization(holderToUse, dataSource, transactionSynchronizationManager));
	...
	public static void applyTimeout(Statement stmt, @Nullable DataSource dataSource, int timeout) throws SQLException {
		...
		if (dataSource != null) {
			holder = (ConnectionHolder) MybatisTransactionScope.getTransactionSynchronizationManager().getResource(dataSource);
		}
	...
	private static class ConnectionSynchronization implements TransactionSynchronization, Ordered {
		...
		public ConnectionSynchronization(ConnectionHolder connectionHolder, DataSource dataSource, TransactionSynchronizationManager transactionSynchronizationManager) {
