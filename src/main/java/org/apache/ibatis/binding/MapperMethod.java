...
import org.apache.ibatis.toolkit.KotlinReflectionUtils;
...
public class MapperMethod {
  ...
  public static class MethodSignature {
    ...
    private final boolean isReactiveType;
    ...
    public MethodSignature(Configuration configuration, Class<?> mapperInterface, Method method) {
      ...
      this.isReactiveType = Publisher.class.equals(this.returnType) || Mono.class.equals(this.returnType) || Flux.class.equals(this.returnType);
      this.returnsVoid = (this.suspendedDeclaredMethod && Unit.class.equals(this.returnType)) || (this.isReactiveType && Void.class.equals(this.returnActualGenericType));
      ...
      this.method = method;
      if(this.suspendedDeclaredMethod && this.isReactiveType){
        throw new BindingException(mapperInterface.getName()+"."+method.getName()+": suspend method should not return reactive type");
      }
      if(!this.suspendedDeclaredMethod && !this.isReactiveType){
        throw new BindingException(mapperInterface.getName()+"."+method.getName()+": method should return reactive type");
      }
    }
    ...
    public Class<?> getReturnType() {
      return suspendedDeclaredMethod ? returnType : returnActualGenericType;
    }
